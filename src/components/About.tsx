          ...
          <div className="bg-transparent rounded-lg shadow-lg px-5 py-6 sm:px-6 my-10 w-full max-w-3xl mx-auto border blur-background2 mt-0">
            ...
            <div className="space-y-6">
              <p className="text-gray-200">
                I&apos;m a 23 year old Developer with 2+ years of experience in Frontend and Backend includes Mobile Applications & Web Dev. <br /> I currently work at Cognus Technology, Udaipur as an Executive Flutter Developer. I completed my B.Tech from Career Point University in 2023 and have been coding since then
              </p>
